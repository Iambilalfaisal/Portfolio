...
export default function Argument() {
  return (
    <section className="mx-auto max-w-6xl px-6 py-24">
      <Reveal>
        <div className="rounded-3xl border border-paper/10 bg-ink/55 backdrop-blur-xl p-8 md:p-12">
          <h2 className="font-mono text-eyebrow uppercase text-grounded-dark mb-6">
            The argument
          </h2>
          <p className="font-sans text-body-lg text-paper measure">
            ...
            touch. Project-Ease needs one law firm&apos;s matters kept out of another&apos;s results, enforced
